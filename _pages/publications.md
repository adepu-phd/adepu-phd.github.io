...
* I am also actively collaborating with industrial partners (Synoptix, Airbus, Qinetiq, Siemens, Thales) in CPS security.
...
* I was awarded [NCSC RITICS](https://www.ncsc.gov.uk/blog-post/ritics-securing-cyber-physical-systems) fellowship as thought leader in the UK within the CPS security. A key outcome is the [NCSC blog](https://www.ncsc.gov.uk/blog-post/digital-twins-secure-design-development) post on Digital Twins: secure design and development, establishing foundational [security guidance](https://www.dataguidance.com/news/uk-ncsc-publishes-blog-secure-design-and-development) for the sector. By
