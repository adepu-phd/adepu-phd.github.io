...
This module was taught between 2022 and 2024 as part of the [MSc Cyber Security (Infrastructures Security)](https://www.bristol.ac.uk/study/postgraduate/taught/msc-cyber-security-infrastructures-security/) programme at the [University of Bristol](https://www.bristol.ac.uk/). The course delivers an in-depth understanding of securing Operational Technology (OT) and [Critical National Infrastructure (CNI)](https://www.bristol.ac.uk/research/groups/cyber-security/msc-cyber-security/) against complex cyber threats.
...
* **IT/OT Convergence:** Managing vulnerabilities that arise when linking business IT systems with physical [Operational Technology networks](https://www.bristol.ac.uk/cdt/cyber-security/tipscdtstudents/stu-profiles/studentprofilejw/).
...
Students gained practical experience using the university's custom [state-of-the-art testbed infrastructures](https://www.bristol.ac.uk/research/groups/cyber-security/msc-cyber-security/) to run simulated attack scenarios and build defensive automation pipelines.
